"""
Django settings for uvita_38388 project.
...
WSGI_APPLICATION = 'uvita_38388.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uvita_38388 API",
    "DESCRIPTION": "API documentation for uvita_38388 App",
    "VERSION": "v1",
}
